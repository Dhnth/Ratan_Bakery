      ...
      >
        ...
        <div className="relative z-20 flex flex-col justify-end p-12 bg-linear-to-t from-[#823b18]/80 to-transparent h-full w-full">
          <h1 className="font-serif text-5xl text-white mb-2">
            Jantungnya Roti Artisanal
          </h1>
          <p className="text-lg text-white/90 max-w-md">
            Rasakan kehangatan roti artisanal yang baru dipanggang, dibuat
            dengan cinta dan tradisi setiap pagi.
          </p>
      ...
      >
        <div className="w-full max-w-md space-y-6">
          ...
          >
            ...
            <div>
              <label
                className="block font-semibold text-sm text-[#28180b] mb-2"
                htmlFor="email"
              >
                Alamat Email
              </label>
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label
                  className="block font-semibold text-sm text-[#28180b]"
                  htmlFor="password"
                >
                  Kata Sandi
                </label>
            ...
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember"
                className="ml-2 block text-sm text-[#54433c] cursor-pointer"
              >
                Ingat saya
              </label>
            </div>
          ...
          <motion.div
            variants={itemVariants}
            className="pt-6 border-t border-[#dac1b8]/30 text-center md:text-left"
          >
