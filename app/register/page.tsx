      ...
      >
        ...
        <div className="relative z-20 flex flex-col justify-end p-12 bg-linear-to-t from-[#823b18]/80 to-transparent h-full w-full">
          ...
          <p className="text-lg text-white/90 max-w-md">
            Jadilah bagian dari keluarga Ratan Bakery. Nikmati roti artisanal
            terbaik setiap hari.
          </p>
      ...
      >
        <div className="w-full max-w-md space-y-6">
          ...
          >
            ...
            <h2 className="font-serif text-4xl text-[#28180b] mb-2">
              Daftar Akun
            </h2>
            <p className="text-[#54433c]">
              Bergabung dengan keluarga artisanal kami
            </p>
          </motion.div>
          ...
          <motion.button
            variants={itemVariants}
            type="button"
            onClick={() => signIn("google", { callbackUrl: "/customer" })} // Ubah dari "/admin" ke "/customer"
          ...
          >
            {/* Nama Lengkap */}
            <div>
              <label className="block font-semibold text-sm text-[#28180b] mb-2">
                Nama Lengkap
              </label>
          ...
          <motion.p
            variants={itemVariants}
            className="text-center text-sm text-[#54433c]"
          >
            Sudah punya akun?{" "}
            <Link
              href="/login"
          ...
          <motion.p
            variants={itemVariants}
            className="text-center text-[11px] text-[#54433c]"
          >
            Dengan mendaftar, Anda menyetujui{" "}
            <Link
              href="#"
              className="text-[#823b18] font-bold hover:underline transition-colors cursor-pointer"
            >
              Syarat & Ketentuan
            </Link>{" "}
            dan{" "}
          ...
          <motion.div
            variants={itemVariants}
            className="pt-4 border-t border-[#dac1b8]/30 text-center"
          >
            <p className="text-[11px] text-[#54433c] opacity-60">
              © 2025 Ratan Bakery. Dibuat dengan cinta.
            </p>
          </motion.div>
        </div>
      </motion.div>
